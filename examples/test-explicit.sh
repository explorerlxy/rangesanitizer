...
RSAN_CFLAGS="-O2 -fno-builtin-malloc -fno-builtin-calloc -fno-builtin-realloc -fno-builtin-free -g -flto=full -fsanitize=safe-stack"
RSAN_LDFLAGS="-fuse-ld=lld -fsanitize=safe-stack"
RSAN_TCMALLOC="-L$RSAN_TC_EXPL_BUILD/lib/ -Wl,-rpath -Wl,$RSAN_TC_EXPL_BUILD/lib/ -ltcmalloc_minimal"
